...
set_property PACKAGE_PIN U4 [get_ports {Anodex[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Anodex[1]}]
set_property PACKAGE_PIN V4 [get_ports {Anodex[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Anodex[2]}]
set_property PACKAGE_PIN W4 [get_ports {Anodex[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Anodex[3]}]
